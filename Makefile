...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Sun May 11 18:02:11 2014
# Project:  assign8.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile assign8.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++-64 -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4 -I. -Ilibs -Iparser -Iinterface/CLI -Iresponder -Iinterface/GUI -Ilogger -Iinterface/GUI/tabs -I. -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/assign81.0.0/ && $(COPY_FILE) --parents libs/book.h libs/db.h libs/library.h libs/log.h libs/shelf.h libs/user.h logger/logger.h parser/node.h parser/parser.h parser/XML.h responder/failure.h responder/responder.h responder/success.h interface/CLI/CLI.h interface/GUI/GUI.h interface/GUI/login.h interface/GUI/mainwindow.h interface/GUI/tabs/all_tab.h interface/GUI/tabs/notification_tab.h interface/GUI/tabs/shelves_tab.h interface/GUI/tabs/tab_widget.h .tmp/assign81.0.0/ && $(COPY_FILE) --parents main.cpp libs/book.cpp libs/db.cpp libs/library.cpp libs/log.cpp libs/shelf.cpp libs/user.cpp parser/node.cpp parser/parser.cpp parser/XML.cpp interface/CLI/CLI.cpp interface/GUI/GUI.cpp interface/GUI/login.cpp interface/GUI/mainwindow.cpp interface/GUI/tabs/all_tab.cpp interface/GUI/tabs/notification_tab.cpp interface/GUI/tabs/shelves_tab.cpp interface/GUI/tabs/tab_widget.cpp .tmp/assign81.0.0/ && $(COPY_FILE) --parents interface/GUI/form.ui interface/GUI/mainwindow.ui .tmp/assign81.0.0/ && (cd `dirname .tmp/assign81.0.0` && $(TAR) assign81.0.0.tar assign81.0.0 && $(COMPRESS) assign81.0.0.tar) && $(MOVE) `dirname .tmp/assign81.0.0`/assign81.0.0.tar.gz . && $(DEL_FILE) -r .tmp/assign81.0.0
...
compiler_moc_header_make_all: moc_login.cpp moc_mainwindow.cpp moc_all_tab.cpp moc_notification_tab.cpp moc_shelves_tab.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_login.cpp moc_mainwindow.cpp moc_all_tab.cpp moc_notification_tab.cpp moc_shelves_tab.cpp
...
moc_mainwindow.cpp: interface/GUI/mainwindow.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) interface/GUI/mainwindow.h -o moc_mainwindow.cpp
...
ui_form.h: interface/GUI/form.ui
	/usr/lib/x86_64-linux-gnu/qt4/bin/uic interface/GUI/form.ui -o ui_form.h

ui_mainwindow.h: interface/GUI/mainwindow.ui
	/usr/lib/x86_64-linux-gnu/qt4/bin/uic interface/GUI/mainwindow.ui -o ui_mainwindow.h
...
mainwindow.o: interface/GUI/mainwindow.cpp interface/GUI/mainwindow.h \
		ui_mainwindow.h \
		libs/db.h \
		parser/XML.h \
		parser/parser.h \
		...
		libs/log.h \
		libs/library.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o mainwindow.o interface/GUI/mainwindow.cpp
