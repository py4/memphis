...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Fri May 9 19:10:00 2014
# Project:  assign8.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/assign81.0.0/ && $(COPY_FILE) --parents libs/book.h libs/db.h libs/library.h libs/log.h libs/shelf.h libs/user.h logger/logger.h parser/node.h parser/parser.h parser/XML.h responder/failure.h responder/responder.h responder/success.h interface/CLI/CLI.h interface/GUI/GUI.h interface/GUI/login.h interface/GUI/main_window.h interface/GUI/tabs/all_tab.h interface/GUI/tabs/tab_widget.h .tmp/assign81.0.0/ && $(COPY_FILE) --parents main.cpp libs/book.cpp libs/db.cpp libs/library.cpp libs/log.cpp libs/shelf.cpp libs/user.cpp parser/node.cpp parser/parser.cpp parser/XML.cpp interface/CLI/CLI.cpp interface/GUI/GUI.cpp interface/GUI/login.cpp interface/GUI/main_window.cpp interface/GUI/tabs/all_tab.cpp interface/GUI/tabs/tab_widget.cpp .tmp/assign81.0.0/ && (cd `dirname .tmp/assign81.0.0` && $(TAR) assign81.0.0.tar assign81.0.0 && $(COMPRESS) assign81.0.0.tar) && $(MOVE) `dirname .tmp/assign81.0.0`/assign81.0.0.tar.gz . && $(DEL_FILE) -r .tmp/assign81.0.0
